<?php
   ...
   include('../session.php');
      ...
      $_SESSION['ds']=$dsname;
      $year=$_SESSION['year'];
  $select=mysqli_query($conn,"select *from student where department='$dsname' and year='$year'");
...
<body>
   <div class="s1">
   	<div class="top"><h1><?php $s=mysqli_query($conn,"select *from department where dsname='$dsname'");$fetch=mysqli_fetch_assoc($s); echo $fetch['dname']; ?> Student List</h1><div class="right"><h1>Total Student</h1><p><?php  echo $counts; ?></p></div></div><hr>
      <div id="printdiv">
   	<table  class="table">
   		<thead>
   		<tr>
         ...
         <tr>
            ...
            <form action="print.php" method="post">
   			<tr>
   				<td colspan="14" bgcolor="gray"><input onclick="print()" type="submit" name="sub" class="sub" value="Print"></td>
