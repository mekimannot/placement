<?php
  ...
  if(isset($_POST['change_password'])){
    ...
    $result = mysqli_query($conn,"update student set  password='$new',status='1' where ID='$session_id'         
		")or die(mysqli_error());
    if ($result) {
     	echo "<script>alert('Your Password Successfully Updated');</script>";
     	echo "<script type='text/javascript'> document.location = 'student_index.php'; </script>";
	} else{
	  die(mysqli_error());
   }
}
  ...
  <div class="container"> 
  	<form action="" method="post">
  		<div class="input_container">
  			<h2>Change Passaword Mandatory</h2><hr>
